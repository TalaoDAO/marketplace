...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
      <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?>" <?php if (module_exists('emh_ethereum')) print 'onclick="validate_exp(); return false;" '; ?>rel="nofollow"><?php print $link_text; ?></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
...
<script type="text/javascript">
  ...
  function validate_exp() {
    ...
    var eid = <?=$entity_id?>;
    var expertid = <?php if (module_exists('emh_ethereum')) { $entity = reset(entity_load('webform_submission', [$entity_id])); print $entity->uid; } else print '0'; ?>;
...
<?php  if (module_exists('emh_ethereum'))
