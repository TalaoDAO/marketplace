...
<?php
  include_once(drupal_get_path('theme','emindhub').'/templates/modules/persona.tpl.php');
  include_once(drupal_get_path('theme','emindhub').'/templates/modules/emhlive.tpl.php');
?>
