...
<div class="profile"<?php print $attributes; ?>>
  ...
  <div class="user-cartouche">
    <?php if ($field_photo || $field_titre_metier || $field_entreprise || $field_address || $field_mail) : ?>
  ...
  <?php if ($field_position || $field_working_status) : ?>
  ...
  <?php if ($field_needs_for_expertise || $field_specific_skills3) : ?>
  ...
  <?php if ($field_domaine || $field_skills_set || $field_position_list || $field_employment_history || $field_cv) : ?>
