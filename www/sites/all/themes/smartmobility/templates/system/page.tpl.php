    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="emh-brand col-md-2">
          <a class="logo navbar-btn" href="<?php print url($base_url . '/' . EMH_SMARTMOBILITY_HOMEPAGE_URL); ?>" title="<?php print t('Smart Mobility'); ?>">
    ...
    <div class="container">
      <div class="row">
        <div class="footer-logo">
          <a href="<?php print url($base_url . '/' . EMH_SMARTMOBILITY_HOMEPAGE_URL); ?>" title="<?php print t('Smart Mobility'); ?>">
