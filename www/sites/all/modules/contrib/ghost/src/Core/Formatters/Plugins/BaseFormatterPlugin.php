...
/**
 * @file
 * Contains a BaseFormatterPlugin
 *
...
/**
 * Class BaseFormatterPlugin
 * @package Drupal\formatters
 */
abstract class BaseFormatterPlugin implements FormatterPluginInterface {
   ...
   *   The form elements.
   */
  abstract public function settingsForm($field, $instance, $view_mode, $form, &$form_state, array $settings = array());
   ...
   *   The summary or NULL
   */
  abstract public function settingsSummary($field, $instance, $view_mode, $settings);
   ...
   */
  abstract public function view($entity_type, $entity, $field, $instance, $langcode, $items, $display);
