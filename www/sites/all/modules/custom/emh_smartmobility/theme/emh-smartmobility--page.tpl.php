...
<section class="emh-module how-it-works hiw">
  ...
  <ul class="hiw-tabs">
    <li><button type="button" name="button" data-tab="hiw-customer" class="hiw-tab emh-button customer"><?php print t('Vous êtes un partenaire'); ?></button></li>
  ...
  <div class="hiw-tab-content hiw-customer emh-module">
    ...
    <div class="emh-subtitle"><?php echo t('Pourquoi Smart Mobility ?') ?></div>
    ...
    <section class="emh-module smartmobility-why">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <p>Choisir les profils avec lesquels vous souhaitez échanger à partir de divers éléments</p>
        </div>
        <div class="col-md-4">
          <img src="<?php print $base_url . '/' . drupal_get_path('theme', 'smartmobility'); ?>/images/requests.svg" alt="" width="150" />
    ...
    <section class="emh-module smartmobility-how">
      ...
      <div class="row container">
        <div class="col-md-3">
          <p>1. Vous publiez vos annonces : recrutements ou missions</p>
        </div>
        <div class="col-md-3">
          <p>2. Des candidats vous répondent via un questionnaire en complément de leur profil et CV</p>
        </div>
        <div class="col-md-3">
          <p>3. Vous analysez les candidatures</p>
        </div>
        <div class="col-md-3">
          <p>4. Vous sélectionnez les profils que vous souhaitez rencontrer</p>
        </div>
      </div>
    </section>
    ...
    <section class="emh-module faq hiw-faq">
        ...
        <div class="emh-subtitle"><?php echo t('FAQ') ?></div>
  ...
  <div class="hiw-tab-content hiw-expert emh-module">
    ...
    <section class="emh-module smartmobility-why">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="<?php print $base_url . '/' . drupal_get_path('theme', 'smartmobility'); ?>/images/requests-alt.svg" alt="" width="150" />
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        </div>
      </div>
