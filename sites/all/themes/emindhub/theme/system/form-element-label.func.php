 ...
 */
function emindhub_form_element_label(&$variables) {
  ...
  if (!empty($element['#description'])) {
    if (theme_get_setting('bootstrap_tooltip_descriptions')) {
      ...
      if (strlen($element['#description']) <= 200) {
        $tooltip = TRUE;
      }
    }
  }
  if ($tooltip) {
    $description = '<span id="' . $element['#id'] . '-description" class="badge help-tip" data-toggle="tooltip" data-placement="bottom" data-html="true" title="' . $element['#description'] . '">?</span>';
  }
