...
Feature: Fill Expert profile fields
  ...
  Scenario: An expert without certain profile fields filled can access request by filling a form
    Given users:
    | name    | mail                            | roles    | field_first_name | field_last_name | field_address:mobile_number | field_other_areas  | og_user_node | field_mail                      |
  ...
  Scenario: An expert with some profile fields filled should not be asked to fill it twice
    Given users:
    | name    | mail                            | roles    | field_first_name | field_last_name | field_address:mobile_number | field_other_areas  | og_user_node | field_mail                      | field_entreprise     |
