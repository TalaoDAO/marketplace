...
Feature: Request
  ...
  Background: Create request
    ...
    | client2 | emindhub.test+client2@gmail.com | business | Charles          | XAVIER       | 0607080901                | Xavier Institute   | X-Men        | emindhub.test+client2@gmail.com | Marvel Studios | Freelancer           | Blockchain       | US                   | Real-time                    |
  ...
  Scenario: Only users belonging to a circle can add a request type restricted to this circle
    ...
    Given users:
    | name    | mail                            | roles    | field_first_name | field_last_name | field_address:mobile_number | field_education  | og_user_node   | field_mail                      | field_entreprise     | field_working_status | field_domaine | field_address:country | field_notification_frequency |
    | client5 | emindhub.test+client4@gmail.com | business | Hank             | MCKOY           | 0607080901                  | Xavier Institute | Cercle de test | emindhub.test+client2@gmail.com | Marvel Studios        | Freelancer           | Blockchain       | US                    | Real-time                    |
