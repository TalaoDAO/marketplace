...
Feature: Jail Circles test
  ...
  Background: Create users
    ...
    | client1 | emindhub.test+client1@gmail.com | business | Charle           | XAVIER          |                             |                    | Smart Mobility     | emindhub.test+client2@gmail.com | Marvel Entertainment | Freelancer           | Blockchain       | US                    |
