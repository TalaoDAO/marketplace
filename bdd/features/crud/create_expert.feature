...
Feature: Create permissions for Experts
  ...
  Background: Create nodes and users
    ...
    | expert1 | emindhub.test+expert1@gmail.com | expert   | Iron             | MAN             | 0712345670                  | Chieur génial      | Avengers  | emindhub.test+expert1@gmail.com | Marvel Studios       | Employee             | Blockchain          | US                  | Real-time                    |
